...
/// <summary>
/// Surface portal prototype. The target scene itself is created and registered by the designer.
/// </summary>
public class PrototypeMapTransitions : MonoBehaviour
{
    ...
    public static void Initialize() => EnsureSurfacePortal();

    private static void EnsureSurfacePortal()
    {
        if (initialized)
            return;
