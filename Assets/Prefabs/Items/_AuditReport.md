...
| `crude_oil` | `Machine:OilDrill` (원유 채굴기) | 2/0/0 |
...
- **Resource1** 9종: diamond, osmium_ingot, raw_osmium_ore, raw_thorium_ore, ruby, sapphire, surface_powder, thorium_ingot, uranium_ingot
- **Machines** 19종 *(이름으로 연결 — 대부분 오탐)*: CoreCrafter, Machine:CementPlant, Machine:ChemicalProcessor, Machine:ElectricFurnace, Machine:Extractor10, Machine:Extractor11, Machine:Extractor12, Machine:Extractor13, Machine:Extractor20, Machine:Extractor21, Machine:Extractor22, Machine:Extractor23, Machine:GeothermalGenerator, Machine:GlassWorks, Machine:HVElectricFurnace, Machine:NuclearPlant, Machine:OilDrill, Machine:Refinery, Machine:Transformer
...
|---|---|---|---|
| `stone` | 23/0/1 | 있음 | 예 |
| `mana_shard` | 17/4/0 | 있음 | 아니오 |
| `conductor_powder` | 13/0/0 | 있음 | 아니오 |
| `iron_plate` | 12/0/0 | 있음 | 아니오 |
| `water` | 7/1/0 | 있음 | 아니오 |
| `computer_chip` | 8/0/0 | 있음 | 아니오 |
| `reinforced_concrete` | 8/0/0 | 있음 | 아니오 |
| `brick` | 8/0/0 | 있음 | 아니오 |
| `crank` | 5/0/0 | 있음 | 아니오 |
| `copper_plate` | 5/0/0 | 있음 | 아니오 |
| `bucket` | 3/2/0 | 있음 | 아니오 |
| `sand` | 4/0/0 | 있음 | 아니오 |
| `metal_plate` | 2/2/0 | 있음 | 아니오 |
| `gravel` | 3/0/0 | 있음 | 아니오 |
| `manastone` | 2/0/1 | 있음 | 예 |
| `glass` | 3/0/0 | 있음 | 아니오 |
| `silicon_plate` | 3/0/0 | 있음 | 아니오 |
| `chipped_stone` | 3/0/0 | 있음 | 아니오 |
| `gas_pipe` | 1/0/1 | 있음 | 예 |
| `rebar` | 2/0/0 | 있음 | 아니오 |
...
| `blast_furnace` | 1/0/0 | 있음 | 아니오 |
| `broken_stone` | 1/0/0 | 있음 | 아니오 |
| `bronze` | 1/0/0 | 있음 | 아니오 |
| `bronze_plate` | 1/0/0 | 있음 | 아니오 |
| `cavity_scanner` | 1/0/0 | 있음 | 아니오 |
| `manual_crusher` | 1/0/0 | 있음 | 아니오 |
| `crumbled_stone` | 1/0/0 | 있음 | 아니오 |
| `distiller` | 1/0/0 | 있음 | 아니오 |
| `dowsing_rod` | 1/0/0 | 있음 | 아니오 |
| `dowsing_rod_t0` | 1/0/0 | 있음 | 아니오 |
| `gas_generator` | 1/0/0 | 있음 | 아니오 |
| `glass_container` | 1/0/0 | 있음 | 아니오 |
| `hydroponics` | 1/0/0 | 있음 | 아니오 |
| `invar` | 1/0/0 | 있음 | 아니오 |
| `uranium_concentrate` | 1/0/0 | 있음 | 아니오 |
| `item_enhancer` | 1/0/0 | 있음 | 아니오 |
| `knife` | 1/0/0 | 있음 | 아니오 |
| `lava` | 1/0/0 | 있음 | 아니오 |
...
合 87종. `Assets/Prefabs/Items/Placeholder` 에는 이미 정본인 것(돌·마력석·파이프)도 섞여 있으니 폴더로 판단하지 말 것.
