...
- 에셋 260개 중 260개 등록 대상, 새로 추가 0개

## 블록

- 에셋 72개 중 72개 등록 대상, 새로 추가 0개
...
- 에셋 160개 중 **160개 등록 대상**, 새로 추가 1개
- 제외: 기계 미지정 0개 · 산출물 없음 0개
...
- `Pulverizer` : 12개
- `Pump` : 2개
- `ResourceGenerator0` : 1개
- `ResourceGenerator1` : 1개
- `ResourceGenerator2` : 1개
